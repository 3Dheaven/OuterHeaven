...
public:
    ...
    Camera(glm::vec3 position = glm::vec3(10.0f, 5.0f, 3.0f), glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f), GLfloat yaw = YAW, GLfloat pitch = PITCH);
	...
	GLboolean needUpdate() const;
	void setUpdate(GLboolean v);
